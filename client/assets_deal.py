...
def main():
    ...
    while i:       
        if frist_date_flag:
            ...
            monitor_new_dic=get_assets_data()
            ...
            if file_md5_old == file_md5_new:
                ...
                #data_assets_change=get_assets_data_change('recv/assets_tmp.log','recv/assets_tmp1.log')
                data_assets_change=get_assets_data_change(monitor_dic,monitor_new_dic)
