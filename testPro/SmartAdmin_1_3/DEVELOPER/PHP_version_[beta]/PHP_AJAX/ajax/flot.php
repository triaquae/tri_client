...
<script type="text/javascript">
	...
	function loadFlotResize() {
		loadScript("<?php echo ASSETS_URL; ?>/js/plugin/flot/jquery.flot.resize.js", loadFlotFillbetween);
	}
	function loadFlotFillbetween() {
		loadScript("<?php echo ASSETS_URL; ?>/js/plugin/flot/jquery.flot.fillbetween.js", loadFlotOrderBar);
	}
	function loadFlotOrderBar() {
		loadScript("<?php echo ASSETS_URL; ?>/js/plugin/flot/jquery.flot.orderBar.js", loadFlotPie);
	}	
	function loadFlotPie() {
		loadScript("<?php echo ASSETS_URL; ?>/js/plugin/flot/jquery.flot.pie.js", loadFlotToolTip);
	}
	function loadFlotToolTip() {
		loadScript("<?php echo ASSETS_URL; ?>/js/plugin/flot/jquery.flot.tooltip.js", generateAllFlotCharts);
	}
