...
<div class="row">
	<div class="col-sm-12">
		...
		<p>
			You can explore some of the <a href="#ajax/form-templates.php" title="Go to Bootstrap Forms">layouts</a> made using Smart Forms grid system or if you are not comfortable with this grid system you can simply stick to the default <a href="#ajax/bootstrap-forms.php" title="Go to Bootstrap Forms">Bootstrap forms</a> 
		</p>
		</div>
