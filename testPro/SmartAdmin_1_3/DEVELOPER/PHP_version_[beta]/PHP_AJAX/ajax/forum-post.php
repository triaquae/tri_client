				...
				<tbody>
					...
					<tr>
                        <td class="text-center">
                        	<a href="#ajax/profile.php"><img alt="" src="<?php echo ASSETS_URL; ?>/img/flags/us.png"> &nbsp; 
                        ...
                        <td class="text-center" style="width: 12%;">
                            <div class="push-bit">
                                <a href="#ajax/profile.php">
                                    <img src="<?php echo ASSETS_URL; ?>/img/avatars/sunny.png" width="50" alt="avatar" class="online">
                                </a>
                            </div>
					...
					<tr>
                        <td class="text-center">
                        	<a href="#ajax/profile.php"><img alt="" src="<?php echo ASSETS_URL; ?>/img/flags/es.png"> &nbsp; 
					...
					<tr>
                        <td class="text-center" style="width: 12%;">
                            <div class="push-bit">
                                <a href="#ajax/profile.php">
                                    <img src="<?php echo ASSETS_URL; ?>/img/avatars/5.png" width="50" alt="avatar" class="offline">
                                </a>
                            </div>
                            <small>473 Posts</small>
                        </td>
...
<script type="text/javascript">
	 ...
	 * SUMMERNOTE EDITOR
	 */
	loadScript("<?php echo ASSETS_URL; ?>/js/plugin/summernote/summernote.js", forumPost);
