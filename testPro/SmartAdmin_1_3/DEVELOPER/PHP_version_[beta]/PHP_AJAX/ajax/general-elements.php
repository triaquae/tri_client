				...
				<div class="row">
					...
					<div class="col-sm-12">
						<p class="alert alert-info">
							<i class="fa fa-info"></i> Did you know you can add more than just the basic colors to customize your badge? <strong>Learn more about color options modifiers on the <a href="#ajax/typography.php">Typography page</a>! </strong>
						</p>
						<!-- row -->
						<div class="row">
						...
						<div class="table-responsive">
							...
							<table class="table table-bordered table-striped hidden-mobile">
								...
								<tbody>
									...
									<tr>
										<td colspan="4">									<pre>
		<code class="html"><span class="nt">&lt;a</span> <span class="na">data-toggle=</span><span class="s">"modal"</span> <span class="na">href=</span><span class="s">"remote.php"</span> <span class="na">data-target=</span><span class="s">"#modal"</span><span class="nt">&gt;</span>
	...
	<div class="row">
		...
		<div class="col-sm-12 col-md-12 col-lg-6">
			...
			<div class="well">
				...
				<p>
					Learn more about other colors that you can use for .well by going to <a href="#ajax/typography.php"> typography page</a>
				</p>
...
<script type="text/javascript">
	...
	loadScript("<?php echo ASSETS_URL; ?>/js/plugin/bootstrap-progressbar/bootstrap-progressbar.js", progressBarAnimate);
