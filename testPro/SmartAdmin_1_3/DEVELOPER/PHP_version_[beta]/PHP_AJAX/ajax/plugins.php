...
<script type="text/javascript">
	...
	$("#spinner-currency").spinner({
	 ...
	 //Maxlength
	loadScript("<?php echo ASSETS_URL; ?>/js/plugin/maxlength/bootstrap-maxlength.min.js", runMaxLength);
	...
	loadScript("<?php echo ASSETS_URL; ?>/js/plugin/bootstrap-timepicker/bootstrap-timepicker.min.js", runTimePicker);
	...
	loadScript("<?php echo ASSETS_URL; ?>/js/plugin/noUiSlider/jquery.nouislider.min.js", noUiSlider);
	 ...
	 * ION SLIDER
	 */
	loadScript("<?php echo ASSETS_URL; ?>/js/plugin/ion-slider/ion.rangeSlider.min.js", ion_slider);
	 ...
	 * COLOR PICKER
	 */
	loadScript("<?php echo ASSETS_URL; ?>/js/plugin/colorpicker/bootstrap-colorpicker.min.js", initializeColorpicker);
	...
	loadScript("<?php echo ASSETS_URL; ?>/js/plugin/bootstrap-tags/bootstrap-tagsinput.min.js");


	/*
	 * KNOB
	 */
	loadScript("<?php echo ASSETS_URL; ?>/js/plugin/knob/jquery.knob.min.js", startKnob);
