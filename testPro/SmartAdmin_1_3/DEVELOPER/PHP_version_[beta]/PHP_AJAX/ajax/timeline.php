				...
				<ul class="smart-timeline-list">
					<li>
						...
						<div class="smart-timeline-content">
							...
							<img src="<?php echo ASSETS_URL; ?>/img/superbox/superbox-thumb-4.jpg" alt="img" width="150">
					...
					<li>
						...
						<div class="smart-timeline-content">
							...
							<ul class="list-inline">
								<li>
									<img src="<?php echo ASSETS_URL; ?>/img/superbox/superbox-thumb-6.jpg" alt="img" width="50">
								</li>
								<li>
									<img src="<?php echo ASSETS_URL; ?>/img/superbox/superbox-thumb-5.jpg" alt="img" width="50">
								</li>
								<li>
									<img src="<?php echo ASSETS_URL; ?>/img/superbox/superbox-thumb-7.jpg" alt="img" width="50">
								</li>
							</ul>
						</div>
					</li>
