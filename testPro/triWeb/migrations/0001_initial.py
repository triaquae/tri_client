...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'triWeb_ip', (
            ...
            ('belongs_to', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['triWeb.trunk_servers'], null=True, blank=True)),
        ...
        db.create_table(u'triWeb_services', (
            ...
            ('plugin', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('trigger', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['triWeb.triggers'], null=True, blank=True)),
        ...
        db.create_table(u'triWeb_triggers', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50)),
            ('expression', self.gf('django.db.models.fields.CharField')(max_length=1000)),
    ...
    models = {
        ...
        u'triWeb.ip': {
            ...
            'custom_services': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['triWeb.services']", 'null': 'True', 'blank': 'True'}),
            ...
            'template_list': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['triWeb.templates']", 'null': 'True', 'blank': 'True'})
        },
        u'triWeb.items': {
        ...
        u'triWeb.services': {
            ...
            'trigger': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['triWeb.triggers']", 'null': 'True', 'blank': 'True'})
        },
        u'triWeb.templates': {
