...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'triggers.expression'
        db.alter_column(u'triWeb_triggers', 'expression', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'triggers.expression'
        db.alter_column(u'triWeb_triggers', 'expression', self.gf('django.db.models.fields.CharField')(max_length=1000))
