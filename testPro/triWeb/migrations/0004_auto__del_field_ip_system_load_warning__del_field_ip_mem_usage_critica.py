...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'IP.system_load_warning'
        db.delete_column(u'triWeb_ip', 'system_load_warning')

        # Deleting field 'IP.mem_usage_critical'
        db.delete_column(u'triWeb_ip', 'mem_usage_critical')

        # Deleting field 'IP.system_load_critical'
        db.delete_column(u'triWeb_ip', 'system_load_critical')

        # Deleting field 'IP.mem_usage_warning'
        db.delete_column(u'triWeb_ip', 'mem_usage_warning')

        # Deleting field 'IP.cpu_idle_warning'
        db.delete_column(u'triWeb_ip', 'cpu_idle_warning')

        # Deleting field 'IP.cpu_idle_critical'
        db.delete_column(u'triWeb_ip', 'cpu_idle_critical')


    def backwards(self, orm):
        # Adding field 'IP.system_load_warning'
        db.add_column(u'triWeb_ip', 'system_load_warning',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'IP.mem_usage_critical'
        db.add_column(u'triWeb_ip', 'mem_usage_critical',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'IP.system_load_critical'
        db.add_column(u'triWeb_ip', 'system_load_critical',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'IP.mem_usage_warning'
        db.add_column(u'triWeb_ip', 'mem_usage_warning',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'IP.cpu_idle_warning'
        db.add_column(u'triWeb_ip', 'cpu_idle_warning',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'IP.cpu_idle_critical'
        db.add_column(u'triWeb_ip', 'cpu_idle_critical',
                      self.gf('django.db.models.fields.IntegerField')(default=0, blank=True),
                      keep_default=False)
