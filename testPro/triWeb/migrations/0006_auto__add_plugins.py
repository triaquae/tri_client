...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'triWeb_plugins', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=150, blank=True)),
            ('plugin_file_name', self.gf('django.db.models.fields.CharField')(max_length=150)),
        ))
        db.send_create_signal(u'triWeb', ['plugins'])


    def backwards(self, orm):
        # Deleting model 'plugins'
        db.delete_table(u'triWeb_plugins')
