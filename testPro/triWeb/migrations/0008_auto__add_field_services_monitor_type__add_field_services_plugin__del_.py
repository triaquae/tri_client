...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'services.monitor_type'
        db.add_column(u'triWeb_services', 'monitor_type',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=50),
                      keep_default=False)

        # Adding field 'services.plugin'
        db.add_column(u'triWeb_services', 'plugin',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['triWeb.plugins']),
                      keep_default=False)

        # Deleting field 'items.plugin'
        db.delete_column(u'triWeb_items', 'plugin_id')

        # Deleting field 'items.monitor_type'
        db.delete_column(u'triWeb_items', 'monitor_type')


    def backwards(self, orm):
        # Deleting field 'services.monitor_type'
        db.delete_column(u'triWeb_services', 'monitor_type')

        # Deleting field 'services.plugin'
        db.delete_column(u'triWeb_services', 'plugin_id')

        # Adding field 'items.plugin'
        db.add_column(u'triWeb_items', 'plugin',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['triWeb.plugins']),
                      keep_default=False)

        # Adding field 'items.monitor_type'
        db.add_column(u'triWeb_items', 'monitor_type',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=50),
                      keep_default=False)
